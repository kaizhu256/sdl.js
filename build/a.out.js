...
function _malloc($bytes) {
 ...
 do if ($bytes >>> 0 < 245) {
  ...
  if ($7 & 3) {
   ...
   $17 = $16 + 8 | 0;
   $18 = HEAP32[$17 >> 2] | 0;
   do if (($14 | 0) == ($18 | 0)) HEAP32[14] = $6 & ~(1 << $12); else {
    if ($18 >>> 0 >= (HEAP32[18] | 0) >>> 0) {
     $25 = $18 + 12 | 0;
  ...
  if ($4 >>> 0 > $34 >>> 0) {
   if ($7) {
    ...
    if ($88) {
     ...
     if (!($94 & $95)) {
      HEAP32[14] = $94 | $95;
      $$pre$phiZ2D = 96 + ($92 + 2 << 2) | 0;
      $F4$0 = $93;
     } else {
      $99 = 96 + ($92 + 2 << 2) | 0;
      $100 = HEAP32[$99 >> 2] | 0;
      if ($100 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
       $$pre$phiZ2D = $99;
       $F4$0 = $100;
      }
     }
   ...
   if (!$106) {
    ...
    $125 = $121 >>> $123;
    $127 = $125 >>> 1 & 1;
    $132 = HEAP32[360 + (($115 | $112 | $119 | $123 | $127) + ($125 >>> $127) << 2) >> 2] | 0;
     ...
     if ($v$0$i$lcssa >>> 0 < $151 >>> 0) {
      ...
      do if ($154) {
       ...
       if (($v$0$i$lcssa | 0) == (HEAP32[$183 >> 2] | 0)) {
        HEAP32[$183 >> 2] = $R$1$i;
        if (!$R$1$i) {
         HEAP32[15] = HEAP32[15] & ~(1 << $182);
         break;
        }
       } else {
        if ($154 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort();
        $192 = $154 + 16 | 0;
       ...
       if ($207) if ($207 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
      ...
      if ($rsize$0$i$lcssa >>> 0 < 16) {
       ...
       if ($225) {
        ...
        if (!($231 & $232)) {
         HEAP32[14] = $231 | $232;
         $$pre$phi$iZ2D = 96 + ($229 + 2 << 2) | 0;
         $F1$0$i = $230;
        } else {
         $236 = 96 + ($229 + 2 << 2) | 0;
         $237 = HEAP32[$236 >> 2] | 0;
         if ($237 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
          $$pre$phi$iZ2D = $236;
          $F1$0$i = $237;
         }
        }
  ...
  if (!$247) {
   ...
   if ((label | 0) == 86) {
    if (($t$1$i | 0) == 0 & ($v$2$i | 0) == 0) {
     ...
     $322 = $318 >>> $320;
     $324 = $322 >>> 1 & 1;
     $t$2$ph$i = HEAP32[360 + (($312 | $309 | $316 | $320 | $324) + ($322 >>> $324) << 2) >> 2] | 0;
     $v$3$ph$i = 0;
    } else {
     $t$2$ph$i = $t$1$i;
     $v$3$ph$i = $v$2$i;
   ...
   if (!$v$3$lcssa$i) {
    $nb$0 = $246;
    label = 154;
   } else if ($rsize$3$lcssa$i >>> 0 < ((HEAP32[16] | 0) - $246 | 0) >>> 0) {
    $346 = HEAP32[18] | 0;
     ...
     if ($v$3$lcssa$i >>> 0 < $348 >>> 0) {
      ...
      do if ($351) {
       ...
       if (($v$3$lcssa$i | 0) == (HEAP32[$380 >> 2] | 0)) {
        ...
        if (!$R$1$i20) {
         HEAP32[15] = HEAP32[15] & ~(1 << $379);
         break;
        }
       } else {
        if ($351 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort();
        $389 = $351 + 16 | 0;
       ...
       if ($404) if ($404 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
      ...
      L179 : do if ($rsize$3$lcssa$i >>> 0 < 16) {
       ...
       if ($rsize$3$lcssa$i >>> 0 < 256) {
        ...
        if (!($426 & $427)) {
         HEAP32[14] = $426 | $427;
         $$pre$phi$i26Z2D = 96 + ($424 + 2 << 2) | 0;
         $F5$0$i = $425;
        } else {
         $431 = 96 + ($424 + 2 << 2) | 0;
         $432 = HEAP32[$431 >> 2] | 0;
         if ($432 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
          $$pre$phi$i26Z2D = $431;
          $F5$0$i = $432;
         }
        }
       ...
       L197 : do if ((HEAP32[$475 + 4 >> 2] & -8 | 0) == ($rsize$3$lcssa$i | 0)) $T$0$lcssa$i = $475; else {
        ...
        if ($$lcssa232 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
 ...
 L212 : do if ((label | 0) == 154) {
  ...
  if ($543 >>> 0 > $nb$0 >>> 0) {
   ...
   if ((label | 0) == 192) {
    $625 = (HEAP32[122] | 0) + $tsize$254$i | 0;
    HEAP32[122] = $625;
    if ($625 >>> 0 > (HEAP32[123] | 0) >>> 0) HEAP32[123] = $625;
    $628 = HEAP32[20] | 0;
    L272 : do if (!$628) {
     $630 = HEAP32[18] | 0;
     if (($630 | 0) == 0 | $tbase$255$i >>> 0 < $630 >>> 0) HEAP32[18] = $tbase$255$i;
     HEAP32[126] = $tbase$255$i;
     HEAP32[127] = $tsize$254$i;
     HEAP32[129] = 0;
     ...
     do {
      $634 = $i$02$i$i << 1;
      $635 = 96 + ($634 << 2) | 0;
      HEAP32[96 + ($634 + 3 << 2) >> 2] = $635;
      HEAP32[96 + ($634 + 2 << 2) >> 2] = $635;
      $i$02$i$i = $i$02$i$i + 1 | 0;
     } while (($i$02$i$i | 0) != 32);
     $641 = $tbase$255$i + 8 | 0;
     $646 = ($641 & 7 | 0) == 0 ? 0 : 0 - $641 & 7;
     $648 = $tsize$254$i + -40 - $646 | 0;
     HEAP32[20] = $tbase$255$i + $646;
     HEAP32[17] = $648;
     ...
     if ((label | 0) == 210) if (!(HEAP32[$sp$183$i$lcssa + 12 >> 2] & 8)) {
      ...
      L297 : do if (($713 | 0) == ($628 | 0)) {
       $723 = (HEAP32[17] | 0) + $718 | 0;
       HEAP32[17] = $723;
       HEAP32[20] = $717;
       HEAP32[$tbase$255$i + ($$sum$i19$i + 4) >> 2] = $723 | 1;
      } else {
       if (($713 | 0) == (HEAP32[19] | 0)) {
        $729 = (HEAP32[16] | 0) + $718 | 0;
        HEAP32[16] = $729;
        HEAP32[19] = $717;
       ...
       if (($734 & 3 | 0) == 1) {
        ...
        L305 : do if ($734 >>> 0 < 256) {
         ...
         do if (($713 | 0) == (HEAP32[$793 >> 2] | 0)) {
          ...
          if ($R$1$i$i) break;
          HEAP32[15] = HEAP32[15] & ~(1 << $792);
          break L305;
         } else {
          if ($764 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort();
          $802 = $764 + 16 | 0;
         ...
         if (!$817) break;
         if ($817 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
       ...
       if ($qsize$0$i$i >>> 0 < 256) {
        ...
        do if (!($835 & $836)) {
         HEAP32[14] = $835 | $836;
         $$pre$phi$i23$iZ2D = 96 + ($833 + 2 << 2) | 0;
         $F4$0$i$i = $834;
        } else {
         $840 = 96 + ($833 + 2 << 2) | 0;
         $841 = HEAP32[$840 >> 2] | 0;
         if ($841 >>> 0 >= (HEAP32[18] | 0) >>> 0) {
       ...
       L385 : do if ((HEAP32[$884 + 4 >> 2] & -8 | 0) == ($qsize$0$i$i | 0)) $T$0$lcssa$i25$i = $884; else {
        ...
        if ($$lcssa >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
         HEAP32[$$lcssa >> 2] = $717;
     ...
     $952 = $936 + 4 | 0;
     HEAP32[$952 >> 2] = 27;
     HEAP32[$937 >> 2] = HEAP32[126];
     HEAP32[$937 + 4 >> 2] = HEAP32[127];
     HEAP32[$937 + 8 >> 2] = HEAP32[128];
     HEAP32[$937 + 12 >> 2] = HEAP32[129];
     HEAP32[126] = $tbase$255$i;
     HEAP32[127] = $tsize$254$i;
     HEAP32[129] = 0;
     HEAP32[128] = $937;
     ...
     if (($936 | 0) != ($628 | 0)) {
      ...
      if ($963 >>> 0 < 256) {
       ...
       if (!($972 & $973)) {
        HEAP32[14] = $972 | $973;
        $$pre$phi$i$iZ2D = 96 + ($970 + 2 << 2) | 0;
        $F$0$i$i = $971;
       } else {
        $977 = 96 + ($970 + 2 << 2) | 0;
        $978 = HEAP32[$977 >> 2] | 0;
        if ($978 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
         $$pre$phi$i$iZ2D = $977;
         $F$0$i$i = $978;
        }
       }
      ...
      L425 : do if ((HEAP32[$1020 + 4 >> 2] & -8 | 0) == ($963 | 0)) $T$0$lcssa$i$i = $1020; else {
       ...
       if ($$lcssa211 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
   ...
   if (($6 | 0) != 1) {
    ...
    do if (!($5 & 1)) {
     ...
     if (!$44) {
      ...
      if (($14 | 0) == (HEAP32[$73 >> 2] | 0)) {
       HEAP32[$73 >> 2] = $R$1;
       if (!$R$1) {
        HEAP32[15] = HEAP32[15] & ~(1 << $72);
        $p$0 = $14;
        $psize$0 = $15;
        break;
       }
      } else {
       if ($44 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort();
       $82 = $44 + 16 | 0;
      ...
      if (!$97) {
       $p$0 = $14;
       $psize$0 = $15;
      } else if ($97 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
       HEAP32[$R$1 + 20 >> 2] = $97;
       HEAP32[$97 + 24 >> 2] = $R$1;
       $p$0 = $14;
       $psize$0 = $15;
    ...
    if ($p$0 >>> 0 < $9 >>> 0) {
     ...
     if ($112 & 1) {
      if (!($112 & 2)) {
       if (($9 | 0) == (HEAP32[20] | 0)) {
        $120 = (HEAP32[17] | 0) + $psize$0 | 0;
        HEAP32[17] = $120;
        HEAP32[20] = $p$0;
        HEAP32[$p$0 + 4 >> 2] = $120 | 1;
        if (($p$0 | 0) != (HEAP32[19] | 0)) break L1;
        HEAP32[19] = 0;
        HEAP32[16] = 0;
        break L1;
       }
       if (($9 | 0) == (HEAP32[19] | 0)) {
        $128 = (HEAP32[16] | 0) + $psize$0 | 0;
        HEAP32[16] = $128;
        HEAP32[19] = $p$0;
       ...
       do if ($112 >>> 0 < 256) {
        ...
        $141 = 96 + ($134 << 1 << 2) | 0;
        do if (($137 | 0) != ($141 | 0)) {
         if ($137 >>> 0 >= (HEAP32[18] | 0) >>> 0) if ((HEAP32[$137 + 12 >> 2] | 0) == ($9 | 0)) break;
         _abort();
        } while (0);
        if (($139 | 0) == ($137 | 0)) {
         HEAP32[14] = HEAP32[14] & ~(1 << $134);
         break;
        }
        do if (($139 | 0) == ($141 | 0)) $$pre$phi59Z2D = $139 + 8 | 0; else {
         if ($139 >>> 0 >= (HEAP32[18] | 0) >>> 0) {
          $156 = $139 + 8 | 0;
        ...
        do if (($163 | 0) == ($9 | 0)) {
         ...
         if ($RP9$0$lcssa >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
        ...
        if ($161) {
         ...
         if (($9 | 0) == (HEAP32[$192 >> 2] | 0)) {
          HEAP32[$192 >> 2] = $R7$1;
          if (!$R7$1) {
           HEAP32[15] = HEAP32[15] & ~(1 << $191);
           break;
          }
         } else {
          if ($161 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort();
          $201 = $161 + 16 | 0;
         ...
         if ($216) if ($216 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
      ...
      if ($psize$1 >>> 0 < 256) {
       ...
       if (!($235 & $236)) {
        HEAP32[14] = $235 | $236;
        $$pre$phiZ2D = 96 + ($233 + 2 << 2) | 0;
        $F16$0 = $234;
       } else {
        $240 = 96 + ($233 + 2 << 2) | 0;
        $241 = HEAP32[$240 >> 2] | 0;
        if ($241 >>> 0 < (HEAP32[18] | 0) >>> 0) _abort(); else {
         $$pre$phiZ2D = $240;
         $F16$0 = $241;
        }
       }
      ...
      $318 = (HEAP32[22] | 0) + -1 | 0;
      HEAP32[22] = $318;
      if (!$318) $sp$0$in$i = 512; else break L1;
      while (1) {
...
function _fflush($f) {
 ...
 do if (!$f) {
  if (!(HEAP32[2] | 0)) $27 = 0; else $27 = _fflush(HEAP32[2] | 0) | 0;
  ___lock(40);
  $$012 = HEAP32[9] | 0;
...
function ___errno_location() {
 var $$0 = 0;
 if (!(HEAP32[3] | 0)) $$0 = 552; else $$0 = HEAP32[(_pthread_self() | 0) + 60 >> 2] | 0;
 return $$0 | 0;
}
